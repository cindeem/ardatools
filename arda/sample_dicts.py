...
if __name__ == '__main__':
    ...
    pibd = generate_sampletype_dict(dataframe, typed, 'PET-PIB-ECAT')
    check_dict_repo(pibd, 'PET-PIB-ECAT')
    pibd = generate_sampletype_dict(dataframe, typed, 'PET-PIB-BIOG')
    check_dict_repo(pibd, 'PET-PIB-BIOG') 
